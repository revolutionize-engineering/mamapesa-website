    ...
    <div className="grid grid-cols-2 py-[2.5rem] font-montserrat bg-[#E18E2A] text-white">
      <div className="px-[5rem] pt-[14%]">
        ...
        <p className="my-8">
          ...
          managing utility services and accessing valuable financial tips, we're
          here to support your goals. Take control of your finances today –
          download MamaPesa and embark on a transformative financial journey.
        </p>
        <button
